...
def cart_page():
    ...
    hybrid_recommendations('Adam Czap', 'AVpgGPyq1cnluZ0-wbTJ', matrix, svd)



    return render_template('cart.html', line_items = line_items, submit_request_form = submit_request_form)
